import "./TeamCard.css";
import { Pencil, Trash2, CalendarSync, RotateCcw } from "lucide-react";
...
function TeamCard({
  ...
  return (
    <div className="team-card">
      <button className="team-card-main" onClick={() => onSelect(team)}>
        <h3>{team.name}</h3>

        <div className="team-overall">
          <span className="team-stars">{stars}</span>
