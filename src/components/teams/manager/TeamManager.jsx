...
import { loadTeams, saveTeams } from "../../../services/teamStorage";
...
function TeamsManager() {
  ...
  function handleCreate() {
    if (teams.length >= MAX_TEAMS) {
      showToast(`Maximum of ${MAX_TEAMS} teams reached.`, "warning");
      return;
    }
  ...
  function confirmUndoSeason() {
    ...
    showToast("Season reverted successfully.", "success");
