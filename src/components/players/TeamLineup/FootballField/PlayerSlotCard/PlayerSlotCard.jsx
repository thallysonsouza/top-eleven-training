...
function PlayerSlotCard({
  ...
  return (
    <div className="player-slot-card">
      <button className="player-slot-main" onClick={onOpenDetails}>
        <div className="player-slot-name">{player.name}</div>
        ...
        <div className="player-slot-footer">
          ...
          <strong className="player-slot-overall">{overallDisplay}</strong>
        </div>
      </button>
