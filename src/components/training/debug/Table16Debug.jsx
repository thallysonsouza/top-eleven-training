...
function Table16Debug({ table16 = [], playerType }) {
  ...
  /* =======================================================
     ...
     Os exercícios já chegam filtrados:
     MEDIA = 0 foram removidos.

     O rank também já foi recriado
     pela engine.
  ======================================================= */
  ...
  return (
    <section className="training-engine-table">
      ...
      <header className="training-engine-table-header">
        <div>
          <small>TABLE 16</small>

          <h2>Values</h2>

          <p>Exercises with zero average removed and ranking recalculated.</p>
        </div>
